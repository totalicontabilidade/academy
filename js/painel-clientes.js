...
(function (global) {
  ...
  function montarFicha() {
      ...
      return painel({
        ...
        corpo: function () {
          return linhaDado("Razão social", e.razaoSocial) +
            ...
            linhaDado("Gerente de contas", e.gerenteNome) +
    ...
    if (vistaFicha === "jornada") {
      html += global.PainelJornada.html(c);
    }
  ...
  function ligarFicha() {
    ...
    if (editar) editar.addEventListener("click", function () {
      if (aberto) global.PainelCadastro.editar(aberto);
    });
  ...
  function iniciar() {
    ...
    /* Os módulos da ficha recebem o que precisam daqui, em vez de
       ler o estado deste arquivo: quem está logado, qual cliente
       está aberto e como redesenhar. */
    var deps = {
      equipe: function () { return equipe; },
      aberto: function () { return aberto; },
      vista: function () { return vistaFicha; },
      desenharFicha: desenharFicha,
      desenharLista: desenharLista,
      atualizarContadores: atualizarContadores,
      campoTexto: campoTexto
    };
    if (global.PainelJornada) global.PainelJornada.iniciar(deps);
    if (global.PainelCadastro) global.PainelCadastro.iniciar(deps);
  ...
  global.PainelClientes = {
    ...
    jornadaPendente: function (c) { return global.PainelJornada.pendente(c); },
    /* Helpers que os módulos da ficha (cadastro, jornada) reutilizam. */
    campoTexto: campoTexto,
